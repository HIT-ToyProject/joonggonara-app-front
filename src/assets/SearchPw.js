...
import UsePhoneSearchPw from './UsePhoneSearchPw';
import UseEmailSearchPw from './UseEmailSearchPw';
        ...
        <View
          ...
          <View style={styles.searchId}>
            <View
              ...
              {phoneChecked ? null : <UsePhoneSearchPw />}
            </View>
            <View
              style={{
                borderWidth: 1,
              ...
              {emailChecked ? <UseEmailSearchPw /> : null}
            </View>
          </View>
        </View>
      </ScrollView>
